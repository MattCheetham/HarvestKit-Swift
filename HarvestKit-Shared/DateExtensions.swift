...
/**
Useful extensions of Date that allow easy access to date information. This extension is used for converting dates to formats that are used by the Harvest API
*/
